'''
This module is to benchmark the newer college models with the psudo ground truth
'''
import cv2
import fire
import numpy as np
...
class NewerCollegeBenchmarksOverPsudoGT(object):
    ...
    def batch_run_over_psudo_gt(self, config, *args, **kwargs):
        ...
        return self.run_benchmarks(config=config, evaluator=evaluator)
    ...
    def run_benchmarks(self, config, evaluator):
...
if __name__ == '__main__':
    fire.Fire(NewerCollegeBenchmarksOverPsudoGT)
